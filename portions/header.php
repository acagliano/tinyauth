<div id="header">
            ...
            <div id="home-dash-toggle">
                <div id="home-button"><a href="/tinyauth">
                        <div class="w3-blue-gray w3-large"><i class="fa fa-home"></i> Home</div>
                </a></div>
                <div id="login-button"><a href="/tinyauth/dashboard/">
            ...
            <div id="infoline-nav">
                ...
                <div id="navigation">
                    <div class="navitem"><a href="/tinyauth/portions/api.php">Documentation</a></div>
                    <div class="navitem"><a href="/tinyauth/portions/legal.php">Legal Notices</a></div>
